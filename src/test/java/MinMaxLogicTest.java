...
public class MinMaxLogicTest {
    ...
    private void assertMinMaxLogic(int expectedSpot) {
        int[] calcResult = this.minMaxLogic.calcMinMax(2, this.board.getGameBoard(), MOVES.CPU_MOVE, Integer.MIN_VALUE, Integer.MAX_VALUE);
    ...
    public void makeCapableMoveList() {
        ...
        assertThat(this.minMaxLogic.makeCapableMOveList(board.getGameBoard()).size(), is(0));
        ...
        for (int i = 0; i < numArray.length; i++) {
            ...
            List<Integer> A = this.minMaxLogic.makeCapableMOveList(board.getGameBoard());
